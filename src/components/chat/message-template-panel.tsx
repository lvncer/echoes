...
export function MessageTemplatePanel({ isOpen, onClose, onTemplateSelect }: MessageTemplatePanelProps) {
      ...
      `}>
              ...
              <Button
                ...
                className={`text-xs ${
                  selectedCategory === category
                    ...
                    : "border-gray-600 text-gray-300 hover:text-white hover:bg-gray-800/50"
                }`}
              >
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3">
          {filteredTemplates.map((template) => (
            <Card
              key={template.id}
              className="p-4 bg-gray-800/50 border-gray-700/50 hover:bg-gray-700/50 
