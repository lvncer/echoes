      ...
      <div
        ...
        className={`mb-4 p-3 rounded-lg ${
          message.role === "user" 
            ...
            : "bg-gray-700/50 mr-8 border border-gray-600"
        }`}
      >
        <div className="flex justify-between items-center mb-1">
          ...
          {/* 時刻表示 - ハイドレーション後にのみ表示 */}
          {isHydrated && <span className="text-xs text-gray-400">{time}</span>}
        </div>
      ...
      <div className="bg-gray-800/50 rounded-lg shadow-lg border border-gray-700">
        ...
        <div className="border-b border-gray-700 p-4">
          <div className="flex justify-between items-center">
            <h1 className="text-xl font-bold text-white">Echoes AI Chat</h1>
        ...
        <div className="h-96 overflow-y-auto p-4 bg-gray-900/20">
          ...
          {isLoading && (
            <div className="bg-gray-700/50 mr-8 p-3 rounded-lg mb-4 border border-gray-600">
